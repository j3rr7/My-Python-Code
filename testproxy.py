...
def main_checker(proxy_type, proxy, position):
    ...
    try:
        ...
        response = requests.get(
            'https://www.google.com/', headers=headers, proxies=proxy_dict, timeout=30)
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=threads) as executor:
        ...
        try:
            ...
            print(
                bcolors.WARNING + 'Number of proxies are less than threads. Provide more proxies or less threads. ' + bcolors.ENDC)
